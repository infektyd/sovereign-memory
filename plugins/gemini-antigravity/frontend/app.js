...
const samplePrepare = {
  ...
  contextMarkdown: "# Gemini Anti Gravity Task Packet\n\nSample packet.",
};
...
const sampleOutcome = {
  ...
  profile: "compact",
  mode: "deterministic",
  changedFiles: ["plugins/gemini-antigravity/frontend/app.js"],
  verification: ["npm test passed", "DESIGN.md lint passed"],
  outcomeDraft: {
    learnCandidates: ["Gemini Anti Gravity Memory frontend should mirror DESIGN.md tokens and avoid automatic learning."],
  ...
  contextMarkdown: "# Gemini Anti Gravity Outcome Packet\n\nSample outcome.",
};
