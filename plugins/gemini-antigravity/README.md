# Gemini Anti Gravity Memory Gemini Anti Gravity Plugin

Local-first Gemini Anti Gravity plugin for Gemini Anti Gravity Memory. It exposes recall, AI-facing vault context packs, manual vault-first learning, learning quality checks, structured Obsidian note writes, and audit tools through MCP.
...
- Gemini Anti Gravity vault: `~/.gemini-antigravity/gemini_antigravity-vault`

Override with:

```bash
export SOVEREIGN_GEMINI_ANTIGRAVITY_VAULT_PATH=/path/to/gemini_antigravity-vault
